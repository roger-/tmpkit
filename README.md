...
This is based on the [tmpcli](https://github.com/ropbear/tmpcli) project and reverse engineering the Deco Android app (`deco_1.10.5.apk`).

Tested only with the TP-Link Deco AX5000, and may not work with other devices.
